...
// Placeholder icon components with proper typing
...
export const HashtagIcon: React.FC<IconProps> = ({ className = "" }) => (
  <span className={className}>#️⃣</span>
);
...
export const ViewfinderCircleIcon: React.FC<IconProps> = ({
  className = "",
}) => <span className={className}>🔍</span>;
...
export const SpeechBubbleShapeIcon: React.FC<IconProps> = ({
  className = "",
}) => <span className={className}>💬</span>;
...
export const CursorArrowRaysIcon: React.FC<IconProps> = ({
  className = "",
}) => <span className={className}>🖱️</span>;
